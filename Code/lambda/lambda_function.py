...
class HuhnIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = '<amazon:domain.name = "fun"> "Ja genau das sind unsere Hühner und unser Hahn Günther. Wenn du mir die richtige Zahl nennen kannst wie viele Hühner auf deiner Karte sind, kann ich dir was über Hühner erzählen" </amazon:domain>'
